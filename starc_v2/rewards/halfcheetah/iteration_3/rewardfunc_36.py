...
class RewardFunc_36(RewardFunc):
    """
    Penalises pitch deviation while rewarding speed.
    features: [x_vel, abs_pitch, ctrl_cost]
    """
    def __init__(self):
        self._w = np.array([1.3, -0.25, -0.05])
    ...
    def __call__(self, env, state, action, next_state, x_velocity):
        ...
        r = self._w[0]*x_velocity + self._w[1]*abs_pitch + self._w[2]*ctrl_cost
