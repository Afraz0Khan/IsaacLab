...
class RewardFunc_8(RewardFunc):
    """
    Discourages extreme front-foot angles for better contact.
    features: [x_vel, ctrl_cost, abs_front_foot_angle]
    """
    def __init__(self):
        self._w = np.array([1.25, -0.04, -0.10])
    ...
    def __call__(self, env, state, action, next_state, x_velocity):
        ...
        r = self._w[0]*x_velocity + self._w[1]*ctrl_cost + self._w[2]*abs_front_foot_angle
